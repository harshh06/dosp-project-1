...
pub fn calculate_optimal_chunk_size(n: Int, num_workers: Int) -> Int {
  case n, num_workers {
    ...
    n, workers -> {
      ...
      let min_chunk = 1000
      let max_chunk = int.min(50_000, n / workers)
